...
import com.koreait.integration1.service.SearchBoardServiceImpl;
...
public class BeanConfiguration {
	...
	@Bean
	public SearchBoardRepository repository() {
		return new SearchBoardRepository();
	}
	
	@Bean
	public SearchBoardServiceImpl searchBoardServiceImpl() {
		return new SearchBoardServiceImpl();
	}
